...
const CommercialPage = () => {
  ...
  <main id="page-service-commercial" className="min-h-screen overflow-hidden bg-background text-foreground">
    ...
    <PageHero
      ...
      subtitle="Offices, retail spaces, clinics, and restaurants built to open on time — a construction company in Hyderabad that tracks risk before it reaches site."
    />
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid items-center gap-16 md:grid-cols-2">
          ...
          >
            ...
            <ConsultationDialog source="service_commercial" buttonLabel="Get a Quote">
              <Button
                size="lg"
